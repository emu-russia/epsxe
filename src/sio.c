...
static unsigned char controller_config_response_byte = 0x0;
static unsigned char netplay_memcard_buffer[0x3820];
static unsigned char controller2_id_byte;
static unsigned char controller2_response_constant;
static unsigned char sio_freeze_state[0x4];
static unsigned char memcard1_directory_next_block[1];
static unsigned char memcard1_directory_frame[0x76];
static unsigned char memcard1_directory_checksum[0x701];
static unsigned char memcard1_block_state_byte0[1];
static unsigned char memcard1_block_state_byte1[1];
static unsigned char memcard1_block_state_byte2[1];
static unsigned char memcard1_block_state_byte3[1];
static unsigned char memcard1_block_next_block[1];
static unsigned char memcard1_save_data[0x1f7f7];
static unsigned char memcard2_header[0x7e];
static unsigned char memcard2_header_checksum;
static unsigned char memcard2_directory_state[1];
static unsigned char memcard2_directory_next_block[1];
static unsigned char memcard2_directory_frame[0x76];
static unsigned char memcard2_directory_checksum[0x701];
static unsigned char memcard2_buffer[0x1f902];
static unsigned int memcard2_checksum;
unsigned char memcard2_data[0x2000];
static unsigned char memcard2_id_byte;
static unsigned int memcard_current_address;
...
static unsigned char sio_controller_state[0x4];
static unsigned char sio_last_command_slot[1];
static unsigned int sio_memcard1_dirty_counter;
static unsigned int sio_memcard1_file_offset;
static unsigned int sio_memcard2_dirty_counter;
static unsigned int sio_memcard2_file_offset;
static unsigned char sio_memcard_data_slot1[1];
static unsigned char sio_memcard_data_slot2[1];
unsigned char sio_memcard_loaded;
static unsigned char sio_multitap_command_buffer[0x40];
static unsigned char sio_multitap_command_byte[0x40];
static unsigned int sio_multitap_slot_counter;
static unsigned int sio_multitap_state;
static unsigned char sio_response_buffer_analog_byte[8];
static unsigned char sio_response_buffer_config_byte[8];
static unsigned char sio_response_buffer_config_byte2[8];
static unsigned char sio_response_buffer_config_byte3[8];
static unsigned char sio_response_buffer_data1[0x100];
static unsigned char sio_response_buffer_data2[0x100];
static unsigned char sio_response_buffer_id[8];
static unsigned int sio_rx_fifo_count;
static unsigned int sio_transfer_length = 0x5;
unsigned int sio_transfer_pending;
unsigned int sio_transfer_timeout;
unsigned char sio_tx_fifo[0x104];
static unsigned char sio_tx_fifo_data[0x100];
