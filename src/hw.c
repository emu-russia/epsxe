#include "pch.h"
void hw_reg_write_word(unsigned int a1, unsigned int a2)
{
  int v2;
  unsigned int v3;
  int v4;
  ...
  {
    *(uint32_t *)&hw_regs[(uint16_t)a1] = a2;
    return;
  }
  ...
  {
    spu_write_register_cb(a1, (uint16_t)a2);
    ...
    else
    {
      switch ( a1 )
      {
        ...
        case 0x1F801098u:
          ...
          break;
        case 0x1F8010A8u:
          *(uint32_t *)gpu_dma_channel_status = a2;
  ...
  if ( a1 <= 0x1F8010E4 )
  {
    ...
    {
LABEL_37:
      mdec_dma_bcr[3 * ((uint8_t)a1 >> 4) - 24] = a2;
    }
    else
    {
      switch ( a1 )
      {
        ...
        case 0x1F8010E0u:
LABEL_32:
          mdec_dma_src[3 * ((uint8_t)a1 >> 4) - 24] = a2;
          break;
        case 0x1F8010C4u:
        case 0x1F8010D4u:
          goto LABEL_37;
        case 0x1F8010C8u:
          *(uint32_t *)spu_dma_chcr_ptr = a2;
          if ( (*(uint32_t *)dma_channel_status & 0x80000) != 0 )
          {
            spu_dma_cb();
            *(uint32_t *)spu_dma_chcr_ptr = a2 & 0xFEFFFFFF;
...
LABEL_51:
  ...
  if ( a1 != 528486632 )
  {
    if ( a1 == 528486640 )
    {
      *(uint32_t *)dma_channel_status = a2;
      return;
    }
    if ( a1 == 528486644 )
    {
...
int16_t hw_reg_read_half(unsigned int a1)
{
  int v1;
  int v2;
  char v3;
...
LABEL_34:
    ...
    else
    {
      ...
      {
        case 0x1F801014u:
          LOWORD(v1) = *(uint16_t *)&hw_regs[(uint16_t)a1];
          break;
        case 0x1F801040u:
          sio_read_data_byte();
          HIBYTE(v4) = v3;
        ...
        case 0x1F801070u:
          ...
          LOWORD(v1) = *(uint16_t *)int_reg | forcepad;
          break;
        case 0x1F801074u:
          LOWORD(v1) = int_mask;
          break;
...
int hw_reg_read_word(unsigned int a1)
{
  int register_cb;
  int result;
  int v3;
...
LABEL_39:
      ...
      else
      {
        ...
        {
          case 0x1F8010F0u:
            result = *(uint32_t *)dma_channel_status;
            break;
          case 0x1F8010F4u:
            result = dma_int_ctrl;
            break;
...
LABEL_15:
      ...
      {
        v4 = *(uint32_t *)gpu_dma_channel_status & 0xFEFFFFFF;
    ...
    else
    {
      switch ( a1 )
      {
        case 0x1F801014u:
        case 0x1F801060u:
          result = *(uint32_t *)&hw_regs[(uint16_t)a1];
          break;
        case 0x1F801040u:
        case 0x1F801044u:
        ...
        case 0x1F801070u:
          ...
          result = *(uint32_t *)int_reg | forcepad;
          break;
        case 0x1F801074u:
          result = int_mask;
          break;
        ...
        case 0x1F8010D0u:
        case 0x1F8010E0u:
          result = mdec_dma_src[3 * ((uint8_t)a1 >> 4) - 24];
          break;
        case 0x1F801088u:
        case 0x1F801098u:
        case 0x1F8010A8u:
  ...
  {
    register_cb = (uint16_t)spu_read_register_cb(a1);
    return register_cb | ((uint16_t)spu_read_register_cb(a1 + 2) << 16);
  }
  return result;
}

int hw_reg_freeze(const char *a1, int a2)
{
  char Buffer[3];
  int v4;
  ...
  gzwrite(a2, (uint8_t *)dma_channel_status, 4u);
  gzwrite(a2, (uint8_t *)hw_saved_state, 4u);
  gzwrite(a2, (uint8_t *)mdec_dma_src, 0x60u);
  return gzwrite(a2, (uint8_t *)hw_regs, 0x10000u);
}

int hw_reg_unfreeze(int a1, uint32_t *a2)
{
  char v3[16];
