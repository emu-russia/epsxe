...
int select_plugins_backend()
{
  ...
  else
  {
    ...
    cdrom_track_to_msf = (int (__cdecl *)(_DWORD, _DWORD, _DWORD, _DWORD))ext_CDR_tarck_to_msf;
    ...
    cdrom_verify_sub_cb = (int (__cdecl *)(_DWORD, _DWORD, _DWORD, _DWORD))ext_CD_verify_subchannel_data;
