...
{
  if ( !strcmp((const char *)&byte_8B1D80, aSpucore) && sound_enabled )
  {
    ...
    spu_play_adpcm_cb = (int)spucore_play_adpcm;
    dword_4FC49C = (int (*)(void))spu_set_adpcm_flag;
    spu_update_cb = spucore_update;
    spu_freeze_cb = (int)spucore_freeze;
    spu_unfreeze_cb = spucore_unfreeze;
  ...
  else
  {
    ...
    spu_play_adpcm_cb = (int)spu_play_adpcm;
    dword_4FC49C = (int (*)(void))spu_set_adpcm_flag;
    spu_update_cb = (int (*)(void))spu_update;
    spu_freeze_cb = (int)spu_freeze;
  ...
  if ( !strcmp((const char *)&byte_8B2180, aW9xcdrcore) )
  {
    ...
    cdrom_play_cdda_cb = W9x_play_cdda;
    cdrom_stop_cb = W9x_cdrom_stop;
    dword_4FC4CC = sub_433610;
    dword_4FC4D0 = (int)nullsub_1;
    dword_4FC4D4 = sub_4337F0;
    dword_4FC4D8 = sub_433930;
    cdrom_subchannel_read_cb = (int (*)(void))W9x_cdrom_subchannel_read;
  }
  else if ( !strcmp((const char *)&byte_8B2180, aW2kcdrcore) )
  {
  ...
  memset(byte_516600, 0, sizeof(byte_516600));
  return 0;
}
