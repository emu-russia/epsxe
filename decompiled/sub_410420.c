...
char sub_410420()
{
  ...
  v0 = (BYTE1(unk_8A7F18) * (__int16)word_8A7F28) >> 8;
  v1 = (BYTE2(unk_8A7F18) * (__int16)word_8A7F2C) >> 8;
  v2 = gte_clamp(-2130706432, unk_8A7FD4 - (((unsigned __int8)unk_8A7F18 * (__int16)word_8A7F24) >> 8));
