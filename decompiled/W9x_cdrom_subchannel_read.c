...
char W9x_cdrom_subchannel_read()
{
  ...
  if ( cd_savefake_flag && loaded_file_type != 3 )
  {
    ...
    if ( use_subchannel )
    {
      ...
      if ( dword_504C8C == 7 )
      {
        sub_431810(0, 2u, 0x10u, 2u, (int)v47, v45);
        result = HIBYTE(v45[1]);
        if ( HIBYTE(v45[1]) )
          return result;
        result = v45[2];
        ...
        if ( SubchannelW9xCaching )
        {
          ...
          do
          {
            for ( i = 0; i < 0x4Bu; i += 5 )
            {
              sub_431810(3u, v40, i, 5u, (int)v47, v45);
...
LABEL_101:
      ...
      sub_431990(0, 2u, 0x10u, 2u, (int)v47);
      if ( !LOBYTE(v47[6]) && *(_WORD *)((char *)&v47[6] + 1) == 5634 )
      {
          ...
          && HIBYTE(v47[2364]) % 10 + 16 * (HIBYTE(v47[2364]) / 10) == 23 )
        {
          ...
          do
          {
            ...
            do
            {
              sub_431990(3u, v41, v19, 5u, (int)v47);
              v20 = v18;
              v21 = &v47[1176];
              v22 = 5;
              do
          ...
          && HIBYTE(v47[2364]) == 23 )
        {
          ...
          do
          {
            for ( j = 0; j < 0x4Bu; j += 5 )
            {
              sub_431990(3u, v42, j, 5u, (int)v47);
              v29 = v27;
              v30 = &v47[1176];
              v31 = 5;
              do
...
LABEL_88:
      ...
      memset(v47, 0xAAu, 0x1F9Cu);
      sub_431A20(0, 2u, 0x10u, 2u, (int)v47);
      ...
      do
      {
        ...
        {
          sub_431A20(3u, v43, k, 0xFu, (int)v47);
