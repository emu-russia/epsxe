...
int sub_41D9D0()
{
  ...
  v2 = v1 & 0xFFFFFFFC;
  v3 = mem_read_word(v1 & 0xFFFFFFFC);
  switch ( v1 & 3 )
  {
    case 0u:
      result = mem_write_word(v2, HIBYTE(cpu_gpr[(unsigned __int8)byte_576DB0]) | v3 & 0xFFFFFF00);
      break;
    case 1u:
      result = mem_write_word(v2, HIWORD(cpu_gpr[(unsigned __int8)byte_576DB0]) | v3 & 0xFFFF0000);
      break;
    case 2u:
      result = mem_write_word(v2, ((unsigned int)cpu_gpr[(unsigned __int8)byte_576DB0] >> 8) | v3 & 0xFF000000);
      break;
    case 3u:
