...
char sub_42C710()
{
  ...
  if ( dword_50BF58 != v1 )
  {
    ...
    LOBYTE(v1) = byte_50AF4F;
    dword_50BF5C = (byte_50AF4F & 0x20) != 0 ? 12 : 24;
    if ( (BYTE2(dword_50AF66) & 0xF) == 4 )
    {
      LOBYTE(v1) = byte_50AF4F & 0x48;
      if ( (byte_50AF4F & 0x48) == 0x40
        || (_BYTE)v1 == 72
        && (_BYTE)dword_50AF66 == (_BYTE)word_50AF54
        && (LOBYTE(v1) = BYTE1(dword_50AF66), BYTE1(dword_50AF66) == HIBYTE(word_50AF54)) )
      {
        LOBYTE(v1) = spu_play_adpcm_cb(&dword_50AF66);
      }
    }
  }
  return v1;
