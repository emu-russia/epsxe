#include "pch.h"
int __cdecl sub_4328D0(int a1, int a2, int a3, char *Buffer)
{
  int v4; // edx
  int v6; // ebx
  int v7; // edi
  ...
  v38 = 75 * ((unsigned __int8)a2 + 60 * (unsigned __int8)a1) + (unsigned __int8)a3 - 150;
  if ( byte_456D70 )
  {
    if ( dword_50C37C == 3 )
    {
      sub_42FF60((unsigned __int8)a1, (unsigned __int8)a2, v7, Buffer);
      if ( auto_ppf_load )
      {
        v9 = sub_42C6D0((unsigned __int8)a1, (unsigned __int8)a2, v7);
        sub_436F60(v9, (int)Buffer);
      }
      if ( byte_456D70 == 1 )
        sub_42F8F0((unsigned __int8)a1, (unsigned __int8)a2, v7, Buffer);
    }
    else
    {
      if ( v38 < dword_4FFF80 || v38 >= dword_4FFF80 + 8 )
      {
        ...
        {
          case 1:
            if ( (unsigned __int8)sub_431900(v4, a2, a3, 8, &unk_4FFF84) )
              dbg_print(" * Error reading CD: %d,%d,%d\n", (unsigned __int8)a1, (unsigned __int8)a2, v7);
            v28 = 0;
            dword_5053E0 = 0;
            dword_5053E4 = 0;
            dword_5053E8 = 0;
            goto LABEL_65;
          case 2:
            if ( (unsigned __int8)sub_431990(v4, a2, a3, 8, &unk_4FFF84) )
              dbg_print(" * Error reading CD: %d,%d,%d\n", (unsigned __int8)a1, (unsigned __int8)a2, v7);
          ...
          case 4:
            ...
            if ( (_BYTE)a1 == 3
              && (dword_50C280 & 0x1F000000) == 0x1F000000
              && (unsigned __int8)sub_431A20(3, a2, a3, 8, dword_504C04) )
            {
              dbg_print(" * Error sub reading CD: %d,%d,%d\n", 3, (unsigned __int8)a2, v7);
            }
            goto LABEL_64;
          case 5:
            ...
            while ( v36 );
            v6 = (unsigned __int8)a2;
            if ( !(unsigned __int8)sub_431900(a1, a2, a3, 8, &unk_4FFF84) )
              goto LABEL_56;
            dbg_print(" * Error reading CD: %d,%d,%d\n", (unsigned __int8)a1, (unsigned __int8)a2, v7);
          ...
          case 6:
            ...
            if ( (_BYTE)a1 != 3 )
              goto LABEL_46;
            v29 = (int *)((char *)dword_504C84 + 1200 * (unsigned __int8)a2 + 16 * v7);
            dword_5053E0 = *v29;
            dword_5053E4 = v29[1];
            dword_5053E8 = v29[2];
            dword_5053EC = v29[3];
            goto LABEL_66;
          case 7:
            if ( (unsigned __int8)sub_431760(v4, a2, a3, 8, &unk_4FFF84) )
              dbg_print(" * Error reading CD: %d,%d,%d\n", (unsigned __int8)a1, (unsigned __int8)a2, v7);
LABEL_46:
            dword_5053E0 = 0;
            dword_5053E4 = 0;
          ...
          case 8:
            memset(dword_504C04, 0, 0x80u);
            if ( (_BYTE)v4 == 3 && (dword_50C280 & 0x1F000000) == 0x1F000000 )
            {
              if ( (unsigned __int8)sub_431810(3, a2, a3, 8, &unk_4FFF84, dword_504C04) )
                dbg_print(" * Error sub reading CD: %d,%d,%d\n", 3, (unsigned __int8)a2, v7);
              v4 = a1;
            }
            if ( (unsigned __int8)sub_431760(v4, a2, a3, 8, &unk_4FFF84) )
...
LABEL_64:
          ...
          case 9:
            ...
            while ( v37 );
            v6 = (unsigned __int8)a2;
            if ( (unsigned __int8)sub_431760(a1, a2, a3, 8, &unk_4FFF84) )
              dbg_print(" * Error reading CD: %d,%d,%d\n", (unsigned __int8)a1, (unsigned __int8)a2, v7);
LABEL_56:
            dword_5053E0 = dword_504C04[0];
            dword_5053E4 = dword_504C08;
          ...
          case 10:
            ...
            if ( (_BYTE)a1 == 3 )
            {
              v32 = (int *)((char *)dword_504C84 + 1200 * (unsigned __int8)a2 + 16 * v7);
              dword_5053E0 = *v32;
              dword_5053E4 = v32[1];
              dword_5053E8 = v32[2];
              v28 = v32[3];
...
LABEL_66:
      ...
      else
      {
        ...
        switch ( dword_504C8C )
        {
          ...
          case 10:
            if ( (_BYTE)a1 == 3 )
            {
              v12 = (int *)((char *)dword_504C84 + 1200 * (unsigned __int8)a2 + 16 * v7);
              dword_5053E0 = *v12;
              dword_5053E4 = v12[1];
              dword_5053E8 = v12[2];
              dword_5053EC = v12[3];
      ...
      if ( auto_ppf_load )
      {
        v35 = sub_42C6D0((unsigned __int8)a1, v6, v7);
        sub_436F60(v35, (int)v10);
      }
      if ( byte_456D70 == 1 )
        sub_42F8F0((unsigned __int8)a1, v6, v7, v10);
    }
    return 0;
  }
  else
  {
    sub_42F990((unsigned __int8)a1, (unsigned __int8)a2, v7, Buffer);
    return 0;
  }
}
