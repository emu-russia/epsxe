...
LABEL_30:
        ...
        if ( v31 >= dword_4557AC - 1 )
          sub_420D60(0, (_BYTE *)(v31 + v30 + 5334371));
        else
          sub_420D60(1, (_BYTE *)(v31 + v30 + 5334371));
        v32 = dword_4557AC;
    ...
    else
    {
      if ( *a1 == 1 )
      {
        ...
        ++byte_516560[65 * (unsigned __int8)byte_516560[0] + 2];
LABEL_9:
        sub_420D60(1, (_BYTE *)(65 * (unsigned __int8)byte_516560[0] + 5334371));
        return;
      }
      if ( *a1 == -127 )
      {
