#include "pch.h"
int __cdecl sub_4042B0(HWND hDlg, unsigned __int16 a2)
{
  int v2; // ebp
  int *v3; // esi
  CHAR *v4; // eax
  ...
  do
  {
    if ( (unsigned __int16)word_455FA8[16 * (unsigned __int8)byte_44DD1A + v2] >= 0x200u )
    {
      sprintf(String, "%d", (unsigned __int16)word_455FA8[16 * (unsigned __int8)byte_44DD1A + v2]);
      v4 = String;
    }
    else
    {
      v4 = &aNone_0[13 * (unsigned __int16)word_455FA8[16 * (unsigned __int8)byte_44DD1A + v2]];
    }
  ...
  if ( a2 < 0xFFu )
  {
    v6 = a2 + 16 * (unsigned __int8)byte_44DD1A;
