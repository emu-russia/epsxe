_DWORD *__cdecl sub_4038F0(_DWORD *a1)
{
  *a1 = 0;
  a1[1] = 0;
  return a1;
...
int __cdecl sub_403DF0(int a1, int a2)
{
  int v2; // ebx
  int v3; // edx
  int v4; // ebp
  ...
  do
  {
    ...
    do
    {
      ...
      while ( v8 );
      sub_403910((int *)(a1 + 16), *(_BYTE *)(v20 + *(_DWORD *)v5), v22, v19, 2);
      v12 = v22;
      v13 = v4;
      v14 = 7;
      do
      ...
      sub_403910((int *)(a1 + 24), *(_BYTE *)(v20 + *(_DWORD *)v5 + 1), v22, v19 + 1, 2);
      v5 += 4;
      ++v4;
      v19 += 56;
    }
...
int sub_403F60(int a1, int a2, int a3)
{
  int v3; // edx
  int v4; // ebx
  int v5; // ebp
  ...
  do
  {
    ...
    do
    {
      ...
      while ( v9 );
      sub_403910(v22, *(_BYTE *)(v21 + *v6), v24, v20, 1u);
      v13 = v24;
      v14 = v5;
      v15 = 7;
      do
      ...
      sub_403910(v22, *(_BYTE *)(v21 + *v6++ + 1), v24, v20 + 28, 1u);
      ++v5;
      v20 += 56;
    }
