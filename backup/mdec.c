...
int __cdecl sub_4292C0(int a1)
{
  int result; // eax

  if ( a1 == 0x80000000 )
  {
    dword_4FC4FC = dword_4FC500;
    return dword_4FC500;
  }
  return result;
}
    ...
    if ( dword_4FC4FC )
    {
      ...
      if ( !v7 )
      {
        ...
        do
        {
          ...
          if ( v3 )
          {
            sub_429D20((char *)dword_512140, v2, (_WORD *)0x1E);
            v2 += 1920;
          }
          else
          {
...
LABEL_15:
        ...
        sub_429B90(v5);
        if ( v3 )
          sub_429D20((char *)dword_512140, v2, (_WORD *)v5);
        else
